...
try{
    ...
    var $iter394 = $locals___main__["symbol_list"];$locals["$next394"] = $B.$getattr($B.$iter($iter394),"__next__")
    while(true){
        try{
    ...
    var $iter395 = $locals___main__["cmd_list"];$locals["$next395"] = $B.$getattr($B.$iter($iter395),"__next__")
    while(true){
        try{
    ...
    var $iter396 = $locals___main__["keyword_list"];$locals["$next396"] = $B.$getattr($B.$iter($iter396),"__next__")
    while(true){
        try{
    ...
    var $iter397 = $locals___main__["intlist"];$locals["$next397"] = $B.$getattr($B.$iter($iter397),"__next__")
    while(true){
        try{
